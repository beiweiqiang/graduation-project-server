...
@WebServlet(
        name = "ChattingHistoryGroupFrenquencyServlet",
        urlPatterns = { "/chattingHistory/groupChattingFrenquency" }
)
public class ChattingHistoryGroupFrenquencyServlet extends HttpServlet {
  private static final Logger myLogger = Logger.getLogger(ChattingHistoryGroupFrenquencyServlet.class.getSimpleName());
...
//    request.setCharacterEncoding("UTF-8");
    ...
    try {
      Map m = DataStatisticsService.queryGroupChattingFrenquencyFrequency(dataStatistics);
