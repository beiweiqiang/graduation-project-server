...
@WebServlet(
        name = "ChattingHistoryWordFrenquencyServlet",
        urlPatterns = { "/chattingHistory/wordFrenquency" }
)
public class ChattingHistoryWordFrenquencyServlet extends HttpServlet {
  private static final Logger myLogger = Logger.getLogger(ChattingHistoryWordFrenquencyServlet.class.getSimpleName());
...
//    request.setCharacterEncoding("UTF-8");
    ...
    try {
      Map m = DataStatisticsService.queryWordFrequency(dataStatistics);
